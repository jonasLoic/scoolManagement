        ...
        .then(function (response) {
            if (response.error) {
                ...
                for (var materiel of response.data) {
                    ...
                    <tr class="tr" >
                                <td class="td"> 
                                        <a style="text-decoration: none; font-size: 20px; text-align: center; color: black; " href="passer_emprunt.html?Id=${materiel._id}">
                                            ${materiel.name}
                                        </a> 
                                </td>
                                <td class="td"> 
                                ...
                                <th style="width: 500px;" class="th"> 
                                        ...
                                        <button id="updateObject" style="background-color:  #242d6e;margin-bottom: 50px;" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Modifier</button>                                   
                                         <button style="background-color:  #8e0808; margin-bottom: 50px;" type="button" id="deleteObject" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_delete">Supprimer</button> 
                                </th>
                        </tr>
                        `)
                    ...
                    axios.get(`http://localhost:3000/api/stuff/${id}`, {
                        ...
                        .then(function (response) {
                            if (response.error) {
                                ...
                                $(".modal-body_Delete").text(`
                                    Voulez vous suprimer: ${response.data.name}?
                                `)

                                
                            $("#modalDeleteObject").click(() => {
